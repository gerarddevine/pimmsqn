...
class CIMObject(Fundamentals):
    ...
    def get_absolute_url(self):
        return ('pimmsqn.apps.qn.views.persistedDoc', 
...
class Doc(Fundamentals):
    ...
    def xmlobject(self):
        ...
        from pimmsqn.apps.qn.Translator import Translator  # needs to be deferred down here to avoid circularity
...
#        return soft_delete(self,*args,**kwargs)
    ...
    def edit_url(self):
        ''' How can we edit me? '''
        return ('pimmsqn.apps.qn.views.%sEdit'%self._meta.module_name,(self.centre_id,self.id,))
